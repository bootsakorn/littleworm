...
<html>
  ...
  <body>
    ...
    $type = strtolower(pathinfo($_FILES['precon']['name'], PATHINFO_EXTENSION));
    $new_image_name = "precon_".$_FILES['precon']['name'];
    $image_path = "precon/";
    ...
    if ($type != "jpg" && $type != "png" && $type != "jpeg" && $type != "gif" ) {
      ...
      $suc = move_uploaded_file($_FILES['precon']['tmp_name'], $upload_path);
      echo '
      <h1><center>อัพโหลดหลักฐาน Pre Condition</center></h1>
      <div class="container" id="result">
        <p>อัพโหลดสำเร็จ</p>
