...
<html>
  ...
  <body>
    ...
    $type = strtolower(pathinfo($_FILES['slip']['name'], PATHINFO_EXTENSION));
    $new_image_name = "slip_".$_FILES['slip']['name'];
    $image_path = "receipt/";
    ...
    if ($type != "jpg" && $type != "png" && $type != "jpeg" && $type != "gif" ) {
      ...
      $suc = move_uploaded_file($_FILES['slip']['tmp_name'], $upload_path);
      echo '
      <h1><center>อัพโหลดหลักฐานการโอนเงิน</center></h1>
      <div class="container" id="result">
        <p>อัพโหลดสำเร็จ</p>
